...
namespace Core.Tests.Extensions
{
    public class StringExtensionsSearchStringTests
    {
        ...
        public StringExtensionsSearchStringTests(ITestOutputHelper testOutputHelper) { _output = testOutputHelper; }
        ...
        [InlineData("    ")]
        [InlineData(" \n\n\r\n ")]
        public void SearchString_Returns_WhiteSpaces_With_No_Changes(string value) { Test(value, string.Empty); }
        ...
        public void SearchString_Change_Arabic_Numeral_To_Arabic_Latin_Numeral(string value, string expected)
        {
            Test(value, expected);
        }
        ...
        [InlineData("ة", "ه")]
        [InlineData("ى", "ي")]
        public void SearchString_Work_With_Arabic_Popular_Equivalent_Characters(string value, string expected)
        {
            Test(value, expected);
        }
        ...
        public void SearchString_Work_With_Arabic_Characters(string value, string expected) { Test(value, expected); }

        [Theory]
        [InlineData("m", "m")]
        [InlineData(" Mahmoud ", "mahmoud")]
        [InlineData("crème brûlée", "cremebrulee")]
        public void SearchString_Work_With_Latin_Characters(string value, string expected) { Test(value, expected); }
