...
namespace X.Core
{
    public class Result
    {
        ...
        public static Result Success() { return new Result { Succeeded = true }; }

        public static Result Failure() { return new Result { Succeeded = false }; }

        public static Result Failure(IEnumerable<string> errors)
        {
            return new Result { Succeeded = false, Errors = errors is string[] e ? e : errors.ToArray() };
        }
