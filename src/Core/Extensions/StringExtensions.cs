...
namespace X.Core.Extensions {
	...
	public static partial class StringExtensions {
		...
		[Pure] public static string NormalizeLineEndings(this string value) {
			return value
				.Replace("\r\n", "\n")
				.Replace("\r", "\n")
				.Replace("\n", Environment.NewLine);
		...
		/// </remarks>
		[Pure] public static string RemoveAccentCharacters(this string input) {
		...
		[Pure] public static string RemoveHiddenChars(this string input) {
