...
namespace X.Core.Extensions
{
    public static class ObjectExtensions
    {
        ...
        /// <returns></returns>
        public static byte[] Bytes(this object obj) { return Encoding.Default.GetBytes(obj.ToJson()); }
        ...
        public static T As<T>(this object obj) { return (T) obj; }
        ...
        public static bool IsIn<T>(this T item, params T[] list) { return list.Contains(item); }
        ...
        /// <param name="list">List of items</param>
        /// <typeparam name="T">Type of the items</typeparam>
        public static bool IsIn<T>(this T item, IEnumerable<T> list) { return list.Contains(item); }
        ...
        /// </returns>
        public static T If<T>(this T obj, bool condition, Func<T, T> func) { return condition ? func(obj) : obj; }
